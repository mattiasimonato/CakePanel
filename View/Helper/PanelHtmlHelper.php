...
class PanelHtmlHelper extends PowerHtmlHelper {
	...
	/*
	protected static $widgetTpl 		= '<div id="{id}" class="widget {class}">{content}</div>';
	protected static $widgetHeaderTpl 	= '<div id="{id}-header" data-toggle="collapse" data-target="#{id}-content" class="widget-header {class}" style="{style}">{content}</div>';
	protected static $widgetBodyTpl 	= '<div id="{id}-content" class="widget-content {class}" style="{style}">{content}</div>';
	*/
